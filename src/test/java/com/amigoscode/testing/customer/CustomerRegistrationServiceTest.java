...
class CustomerRegistrationServiceTest {
    ...
    @Test
    void itShouldSaveNewNumberWhenIdIsNull() {
        // Given a phone number and a customer
        String phoneNumber = "000099";
        Customer customer = new Customer(null, "Maryam", phoneNumber);
    ...
    void itShouldThrowWhenPhoneNumberIsTaken() {
        ...
        String phoneNumber = "000099";
        Customer customer = new Customer(UUID.randomUUID(), "Maryam", phoneNumber);
        Customer customerTwo = new Customer(UUID.randomUUID(), "Gomez", phoneNumber);
        ...
        // Then
        assertThatThrownBy(() -> underTest.registerNewCustomer(request))
                .hasMessageContaining(String.format("phone number [%s] is taken", request.getCustomer().getPhoneNumber()))
                .isInstanceOf(IllegalStateException.class);
